...
public class ObjectiveCompleteLaps : Objective
{
    ...
    [Tooltip("Save locally the best time achieved in this Scriptable.")]
    public GameScoreScriptable score;
    ...
    protected override void ReachCheckpoint(int remaining)
    {
        ...
        {
            /*if(score != null) 
                score.bestTime = GameObject.Find("BestLap/Time").GetComponent<TMP_Text>().text;//<----- Modify this n*/
